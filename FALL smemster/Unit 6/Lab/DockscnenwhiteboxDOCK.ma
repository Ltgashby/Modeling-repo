...
//Name: DockscnenwhiteboxDOCK.ma
//Last modified: Fri, Oct 04, 2024 11:39:26 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "59024F28-42C2-ABD8-B901-A183D68732B3";
createNode transform -s -n "persp";
	rename -uid "62B43E80-4B2F-778D-F508-33BE910F1467";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.0956481905556572 2.7415708632053146 17.093012000855179 ;
	setAttr ".r" -type "double3" -8.7383527297144354 16.599999999988242 -4.1485961593340307e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "ACB7D7D1-4F86-23B8-6CE5-88A4300330FF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 18.045855494851782;
...
createNode mesh -n "ConcreteshelldockShape" -p "Concreteshelldock";
	...
	setAttr -s 7 ".pt[1:7]" -type "float3"  1 0 0 0 0.5 0 1 0.5 0 0 0.5 
		-7 1 0.5 -7 0 0 -7 1 0 -7;
createNode transform -n "sandshell";
	rename -uid "057EF81D-489E-F1A9-FA1A-CC93C57F2389";
	setAttr ".t" -type "double3" 4 0.19698587138468002 0 ;
	setAttr ".rp" -type "double3" 0 -0.19698587138468002 0 ;
	setAttr ".sp" -type "double3" 0 -0.19698587138468002 0 ;
...
createNode transform -n "watershell";
	...
	setAttr ".t" -type "double3" 4 0.59095761258417345 0 ;
	setAttr ".rp" -type "double3" 0 -0.19698587138468002 0 ;
	setAttr ".sp" -type "double3" 0 -0.19698587138468002 0 ;
...
createNode transform -n "Dockshell";
	...
	setAttr ".t" -type "double3" 4 1.3030141294002533 0 ;
createNode mesh -n "DockshellShape" -p "Dockshell";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 7 ".pt";
	setAttr ".pt[0]" -type "float3" 0 0.2758033 0 ;
	setAttr ".pt[1]" -type "float3" -2.5683422 0.2758033 0 ;
	setAttr ".pt[3]" -type "float3" -2.5683422 0 0 ;
	setAttr ".pt[5]" -type "float3" -2.5683422 0 0 ;
	setAttr ".pt[6]" -type "float3" 0 0.2758033 0 ;
	setAttr ".pt[7]" -type "float3" -2.5683422 0.2758033 0 ;
	setAttr -s 8 ".vt[0:7]"  -2 -0.19698587 4 2 -0.19698587 4 -2 0.19698587 4
		 2 0.19698587 4 -2 0.19698587 -4 2 0.19698587 -4 -2 -0.19698587 -4 2 -0.19698587 -4;
	setAttr -s 12 ".ed[0:11]"  0 1 0 2 3 0 4 5 0 6 7 0 0 2 0 1 3 0 2 4 0
		 3 5 0 4 6 0 5 7 0 6 0 0 7 1 0;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "846C1E8A-474E-5D2C-0946-0790B524E09F";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "AF2FF108-4582-AC2D-A04E-86BCFA88EB0E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B351E131-4C54-0BA0-A5A4-EF971388BD77";
createNode displayLayerManager -n "layerManager";
	rename -uid "FBC68EDB-45E4-97A9-9FDB-46AAA475181D";
createNode displayLayer -n "defaultLayer";
	rename -uid "969E9827-4CAA-2267-9FB7-1A9BF3C67EED";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "9D689206-469A-FB10-7D42-14A5CAA966BF";
...
createNode polyCube -n "polyCube1";
	rename -uid "D8AA640A-446E-00A3-264D-C59DA6EAF62C";
	setAttr ".cuv" 4;
createNode polyCube -n "polyCube2";
	rename -uid "E6E96F44-4E83-C6D1-44DE-5EA200E1DB94";
	setAttr ".w" 4;
	setAttr ".h" 0.39397174276936003;
	setAttr ".d" 8;
	setAttr ".cuv" 4;
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "E3FC1F9C-4F95-4173-DD1A-3BAFBD198667";
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "polyCube1.out" "ConcreteshelldockShape.i";
connectAttr "polyCube2.out" "sandshellShape.i";
...
// End of DockscnenwhiteboxDOCK.ma
